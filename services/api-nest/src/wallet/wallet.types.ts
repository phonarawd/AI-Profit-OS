...
export const PAYABLE_SUFFIX_ROLE = "bank_transfer_identification" as const;
export type PayableSuffixRole = typeof PAYABLE_SUFFIX_ROLE;

export type KrwDepositQuoteV1 = {
  fxSnapshotId: string;
  usdtKrw: string;
...
export type KrwDepositRequestV1 = {
  ...
  ledgerJournalId?: string;
  estimatedUsdt?: string;
  quote: KrwDepositQuoteV1 | null;
  final: KrwDepositFinalV1 | null;
  idempotencyKey: string;
  createdAt: string;
  decidedAt?: string;
