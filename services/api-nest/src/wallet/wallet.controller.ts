...
export class WalletController {
  ...
  @UseGuards(JwtAuthGuard)
  @Get(WALLET_USER_ROUTES.krwDepositRequests)
  listKrwDeposits(@Req() req: SessionReq) {
    return this.krwDeposit.listForUser({
      userId: this.sessionUserId(req),
    });
  }

  @UseGuards(JwtAuthGuard)
  @Get(WALLET_USER_ROUTES.krwDepositRequestById)
  getKrwDeposit(@Param("id") id: string, @Req() req: SessionReq) {
    return this.krwDeposit.getForUser(this.sessionUserId(req), id);
  }
