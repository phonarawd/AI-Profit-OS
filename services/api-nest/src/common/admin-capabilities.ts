...
> = Object.freeze({
  ...
  MembershipAdminController: {
    ...
    getDailyMatchCap: read("userMatchPolicy"),
    putDailyMatchCap: write("userMatchPolicy"),
    effectivePreview: read("userMembershipForce"),
    listGradeDailyCaps: read("userMatchPolicy"),
    putGradeDailyCaps: write("userMatchPolicy"),
    listBonus: read("userMatchPolicy"),
    grantBonus: write("userMatchPolicy"),
    reclaimBonus: write("userMatchPolicy"),
    quotaProjection: read("userMembershipForce"),
    listPresentationProfile: read("userMatchPolicy"),
    putPresentationProfile: write("userMatchPolicy"),
  },
  ...
  MiningAdminController: {
    listMines: read("all"),
    createMine: write("all"),
    getMine: read("all"),
    updateMine: write("all"),
    publishMine: write("all"),
    pauseNewPositions: write("circuit"),
    pauseMine: write("circuit"),
    resumeMine: write("circuit"),
    endMine: write("all"),
    listRateVersions: read("all"),
    createRateVersion: write("all"),
    updateRateVersion: write("all"),
    requestRateApproval: write("all"),
    approveRateVersion: write("all"),
    scheduleRateVersion: write("all"),
    listPositions: read("ledger"),
    getPosition: read("ledger"),
