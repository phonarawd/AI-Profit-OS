    ...
    >
      ...
      {tab === "queue" ? (
              ...
              {items.map((item, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <details className="mt-2 text-pd-text-muted">
                      ...
                      <div className="mt-2 flex flex-wrap gap-2">
                        {userId ? (
                          <>
                            ...
                            <a
                              className="rounded px-2 py-1 text-pd-text-muted underline"
        ...
        >
          ...
          {!circuit ? (
            ...
            <div className="mt-3 text-sm">
              ...
              {circuit.data.open === true ? (
                <button
                  type="button"
                  className="mt-2 rounded bg-pd-elevated px-2 py-1"
          ...
          {!catalog ? (
            <p className="mt-3 text-sm text-pd-text-muted">확인 기준을 불러오고 있어요</p>
          ) : !catalog.ok ? (
            <AdminFetchNote failure={catalog.failure} />
          ) : abuseRules.length === 0 && errorRules.length === 0 ? (
            <p className="mt-3 text-sm text-pd-text-muted">등록된 확인 기준이 없습니다.</p>
          ) : (
