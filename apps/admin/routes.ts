...
export const ADMIN_CHILD_ROUTES = [
  ...
  { href: "/admin/users/:id?tab=policy", parent: 6, note: "B7 matching policy" },
  ...
  { href: "/admin/users/:id/adjust", parent: 6, note: "B4 journal adjust" },
  { href: "/admin/system-control?tab=ops", parent: 9, note: "admin-ops modes" },
  { href: "/admin/opportunities?tab=match", parent: 2, note: "match-control verbs" },
