    ...
    <Link href={item.href} className="sdpm-card" data-sdpm="card">
      ...
      <div className="sdpm-capital" data-sdpm="capital">
        ...
        {item.capitalUsdt ? (
          ...
          <p className="sdpm-money" data-sdpm-capital="unavailable">
            <span className="amt">확인할 수 없음</span>
          </p>
        )}
...
function ProfitsMobileSkeleton() {
  return (
    <div className="sdpm-skel-list" role="status" aria-busy="true" aria-label="기회를 불러오는 중">
