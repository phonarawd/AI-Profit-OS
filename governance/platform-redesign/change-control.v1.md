...
| 5 | token hierarchy | L2 | `03` (handed off) · `peotteok-light` |
...
| level | **L3** |
| before | Dark theme(`lux-dark`) 중심 개발자/트레이딩 톤 · dual theme/toggle 잔존 가능 가정 |
| after | 출시 SSOT = **`peotteok-light` Light+Purple 단일 테마** · Dark theme = archive/legacy · dual toggle **0** |
