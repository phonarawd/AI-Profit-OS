...
LIVE_AGGREGATE = c2a6ea416128aa648eb9ddb0ceb6249a0633f12e0eb6fbabc4d986c80fc3c3bf
BASELINE_AGGREGATE = c2a6ea416128aa648eb9ddb0ceb6249a0633f12e0eb6fbabc4d986c80fc3c3bf
PATH_COUNT_LIVE = 556
PATH_COUNT_BASELINE = 556
CHANGED_PATHS = 0
ADDED_PATHS = 0
MUTATED_PATHS = 0
MISSING_PATHS = 0
EXIT_GATE = recovery/release-provenance-20260831 @ 9d51acabe034fd4ceffa18bc01c530a378638c38 · current-epoch QA0-QA9 COMPLETE · QA9 ENGINE_ACCEPTED_FOR_UI · FINAL_ACCEPTANCE ISSUED
```

## 판정

Human/PO 승인 ACK는 `product-rebases.v1.json`에 원문 그대로 보존되어 있으며,
승인된 product commit `f295d67f1c3c5b0cbc824c06e568074fd382e85a`의 protected-scope 변경은
predecessor baseline `ea-baseline-137241804ff2-83935adcdf57`에서
current baseline `ea-baseline-f295d67f1c3c-c2a6ea416128`로 formal rebase되었다.

Formal rebase는 `ENGINE_ACCEPTANCE_REBASE_POLICY_V2`에 따라 적용되었고,
rebase id는 `ea-rebase-f295d67f1c3c-c2a6ea416128`이다. Predecessor evidence/hash washing은 수행하지 않았으며
predecessor QA9 verdict는 history로만 유지한다.

Current epoch의 QA1~QA8은 모두 같은 baseline에서 `COMPLETE`이고,
formal QA7은 GitHub Actions run `34968710565`의 실제 Actions evidence를 사용했다.
...
`c2a6ea416128aa648eb9ddb0ceb6249a0633f12e0eb6fbabc4d986c80fc3c3bf`로 일치하며 current protected-scope drift는 0이다.
