...
REBASE_ID = pending
LIVE_AGGREGATE = 243888b7cd1e02fc1468417d12adbd83d038a890bb173082759c54222e05f065
...
MUTATED_PATHS = 39
MISSING_PATHS = 0
EXIT_GATE = recovery/release-provenance-20260831 @ 56503b95d8a57848fa560daad17a8d49c19dfc00 · ENGINE_ACCEPTANCE_REBASE_V1 ACK 후 QA0-QA9 재실행 전까지 ISSUED 금지
```

## 판정

recovery candidate `56503b95d8a57848fa560daad17a8d49c19dfc00` 의 live protected-scope 는 baseline 과 다르다.
`LIVE_AGGREGATE = 243888b7cd1e02fc1468417d12adbd83d038a890bb173082759c54222e05f065`
`PATH_COUNT_LIVE = 488` · `CHANGED_PATHS = 77` (added 38 · mutated 39 · missing 0).
