...
MUTATED_PATHS = 0
MISSING_PATHS = 0
EXIT_GATE = recovery/release-provenance-20260831 @ cb71cf91b6982471edab426ab06a14947a7f4de5 · current-epoch QA0-QA9 COMPLETE · QA9 ENGINE_ACCEPTED_FOR_UI · FINAL_ACCEPTANCE ISSUED
```
...
formal QA7은 GitHub Actions run `34705378591`의 실제 Actions evidence를 사용했다.
