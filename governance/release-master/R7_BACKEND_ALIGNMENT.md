...
| migration_head | local `20260909060000` | remote applied `20260906170000` | PENDING (`65ab999b` applied only `20260906170000` via single-file apply. REL-701-DB batch stays applied. committedUnapplied now has 12 files through `20260909060000` trial welcome grant. Future apply must use `--include-all` because those pre-head versions were skipped and the new local head is also unapplied.) | REL-701-DB / S1F / PUTDUK / S5 |
