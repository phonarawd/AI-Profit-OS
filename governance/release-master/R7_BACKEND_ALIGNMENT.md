...
| migration_head | local `20260909060000` | remote applied `20260909060000` | ALIGNED (Track C 2026-09-09 applied 10 leftover files in version order. Remote trial row stays `20260909040657` alias of local `20260909060000`. Remote `20260908052954` stays alias of local `20260906150000` s3_33. committedUnapplied 0. REL-701-DB include-all lineage.) | REL-701-DB / S1F / PUTDUK / S5 |
