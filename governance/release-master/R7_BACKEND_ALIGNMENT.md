...
`services/api-nest` + `supabase/migrations` protected-scope 변경은 REL-502 formal rebase(`ea-baseline-009750f0bef8-60f2feeec9d3`)에 포함되었고 drift는 0이다.
...
| migration_head | local `20260916080000` | remote applied `20260916080000` | ALIGNED (MCP apply_migration 2026-09-16 · remote stamp `20260915220821` mapped · REL-701-DB 실행 이력 유지) | REL-701-DB |
