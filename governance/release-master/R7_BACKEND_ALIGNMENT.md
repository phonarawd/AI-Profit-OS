...
REL-502 current-epoch QA0~QA9는 새 baseline에서 STALE_PENDING_RERUN이다. FINAL_ACCEPTANCE는 NOT_ISSUED이며 현재는 CERT_ISSUED=0 · STALE_PENDING_REBASE=1이다. predecessor 인증을 current로 세탁하지 않았다.
...
| p0_p3_engine | REL-502 `FINAL_ACCEPTANCE` | DEFECTS_P0/P1 = 0 | STALE_PENDING_REBASE (NOT_ISSUED · QA rerun) | REL-502 |
