...
const profitsPage = read("apps/web/app/profits/ProfitsPageClient.tsx");
if (!profitsPage.includes("CategoryFilterChips")) {
  fails.push("ProfitsPageClient must include CategoryFilterChips (Home H7 removed Home call)");
}
