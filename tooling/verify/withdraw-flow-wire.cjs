...
if (
  ...
  pageIsSkeleton("apps/web/app/wallet/withdraw/page.tsx")
) {
  console.log("[withdraw-flow-wire.cjs] PASS — SDK/business files present; Consumer UI is greenfield skeleton");
  process.exit(0);
}
