...
| wallet-contract | Track B B-WALLET-001 — **live** (4레일 Product/Visual/Implementation 계약 · `CONSUMER_WALLET_CONTRACT.md` + `governance/consumer-wallet/wallet.v1.json` · web 8면 PendingFigma 재실측 · Spark Dash DNA=CONSTRAINT_ONLY · Home geometry 종속 0 · Money Rule 재정의 0 · 배선=`B-WALLET-002`) |
