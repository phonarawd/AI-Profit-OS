...
| 경로 패턴 | verify |
|-----------|--------|
| `docs/product/consumer/**` · `docs/product/PUTDUK_PRODUCT_DESIGN_ENGINEERING_OPERATING_SYSTEM.md` · `tooling/verify/consumer-ux-architecture.cjs` · `tooling/verify/core-loop-contract.cjs` · `tooling/verify/participate-web-wire.cjs` · `tooling/verify/execute-web-wire.cjs` · `tooling/verify/trades-web-wire.cjs` · `tooling/verify/core-loop-release.cjs` · `tooling/verify/lib/core-loop-release-runtime.cjs` · `governance/consumer-loop/**` · `apps/web/app/profits/[id]/**` · `apps/web/app/trades/**` · `packages/sdk/src/index.ts` · `packages/sdk/src/participate/**` · `packages/sdk/src/execution-stream/**` · `packages/sdk/src/trades/**` | consumer-ux-architecture · core-loop-contract · participate-web-wire · execute-web-wire · trades-web-wire · core-loop-release (B-LOOP-002 성공/Safe-Stop E2E) |
