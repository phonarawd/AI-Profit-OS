...
| 경로 패턴 | verify |
|-----------|--------|
| `docs/product/consumer/**` · `docs/product/PUTDUK_PRODUCT_DESIGN_ENGINEERING_OPERATING_SYSTEM.md` · `tooling/verify/consumer-ux-architecture.cjs` · `tooling/verify/core-loop-contract.cjs` · `tooling/verify/participate-web-wire.cjs` · `tooling/verify/execute-web-wire.cjs` · `tooling/verify/trades-web-wire.cjs` · `governance/consumer-loop/**` · `apps/web/app/profits/[id]/**` · `apps/web/app/trades/**` · `packages/sdk/src/index.ts` · `packages/sdk/src/participate/**` · `packages/sdk/src/execution-stream/**` · `packages/sdk/src/trades/**` | consumer-ux-architecture · core-loop-contract · participate-web-wire · execute-web-wire · trades-web-wire (B-TRADES-001 `/trades` → `GET /api/v1/trades`) |
...
| core-loop-contract | Track B B-LOOP-001 — **live** (Product/Visual/Implementation 계약 · `CONSUMER_CORE_LOOP_CONTRACT.md` + `governance/consumer-loop/core-loop.v1.json` · participate 배선 후 재실측 · Engine Rule 재정의 0 · release E2E=`B-LOOP-002`) |
