...
| acquisition-contract | Track C C-ACQ-001 — **live** (Landing/Auth/Signup/Onboarding Product/Visual/Implementation 계약 · `CONSUMER_ACQUISITION_CONTRACT.md` + `governance/consumer-acquisition/acquisition.v1.json` · web 7면 PendingFigma · Kakao start+exchange PRESENT · Home geometry 종속 0 · Auth Rule 재정의 0 · 배선=`C-ACQ-002`) |
