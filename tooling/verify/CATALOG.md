...
| `apps/web/app/me/**` · `governance/consumer-account-hub/**` · `packages/sdk/src/referral/**` · `packages/sdk/src/inbox/**` | account-hub-contract (C-ACC-001) · account-hub-gap-wire (C-ACC-002) |
