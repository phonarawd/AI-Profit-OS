...
| tron-hd-derivation-fail-closed | Wallet TRC20 — synthetic HMAC(secretRef,path) forbidden · canonical BIP32/secp256k1 deriver required · legacy rows are not served/watched/resolved without authority · ingest caller userId is never ownership authority · unbound vault fails HTTP 503 before read/serve/credit/INSERT — **live** |
