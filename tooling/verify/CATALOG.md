...
| `apps/web/app/me/**` · `governance/consumer-account-hub/**` | account-hub-contract (C-ACC-001) |
...
| account-hub-contract | Track C C-ACC-001 — **live** (Profile/Referral/Notifications/KYC/Settings/Support/Guides/Legal Product/Visual/Implementation 계약 · `CONSUMER_ACCOUNT_HUB_CONTRACT.md` + `governance/consumer-account-hub/account-hub.v1.json` · web primary 18 PendingFigma · 호환 4면 보존 · SDK KYC/session PRESENT · referral/inbox MISSING · Home geometry 종속 0 · Auth/Money Rule 재정의 0 · 배선=`C-ACC-002`) |
