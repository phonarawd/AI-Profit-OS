...
| rc-formal | `verify:rc-formal` | T0 path | live (RC_FORMAL lock · ISSUED or pending-rerun after rebase · drift 0 · history 82 · one-shot removed · prod apply 0) |
...
| operator-row-protect | S1 외부 카탈로그 쓰기 게이트(기본 OFF) · `supply_source=operator` 행 보호 · 잠금 후 재평가 · mock 격리 · 토큰 503/401 유지 — **live** |
