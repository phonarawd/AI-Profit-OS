...
| auth-runtime-readiness | API health — user JWT session readiness exposed as configured boolean only · secret value 0 · missing JWT can no longer hide behind DB/Redis green — **live** |
