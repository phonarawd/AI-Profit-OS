...
| auth-runtime-readiness | API health — JWT/Kakao/Resend readiness booleans only · secret values 0 · missing provider config cannot hide behind DB/Redis green — **live** |
