...
| ai-scope-guard | Engine §47.16.4 — `OFF_TOPIC_PATTERNS`→`scope_redirect`(LLM0·tools=[]) · meta residual guard · G프롬프트 1줄 · eval/g_scope_escape §H 7 · assurance 3단계(complete=NOT_PROVEN) · numeric 비침범 — **live** |
