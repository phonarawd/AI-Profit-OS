...
| tron-hd-derivation-fail-closed | Wallet TRC20 — synthetic HMAC(secretRef,path) forbidden · canonical BIP32/secp256k1 deriver required · existing legacy rows are not served without authority · unbound vault fails HTTP 503 before read/serve/INSERT — **live** |
