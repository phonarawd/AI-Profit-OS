...
| rel-602-staging-rollback | `verify:rel-602-staging-rollback` | T0 path + CI | live (REL-602 staging rollback practice · fake COMPLETED 0 · pending blockers OK) |
...
| `governance/release-master/REL-602-STAGING-ROLLBACK.md` · staging rollback · `tooling/verify/rel-602-staging-rollback.cjs` | rel-602-staging-rollback |
