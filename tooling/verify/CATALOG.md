...
| balance-aware-feed | Engine §0.0.5.1 · Money §49.2a · UI §5.3a — **live Money path** (suggest query·principal Fact·deposit prefill·feed invalidate · Engine pointer) · Engine/UI feed surfaces harden with their todos (v7.22.21) |
