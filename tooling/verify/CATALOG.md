...
| rel-502-publication-safety | `verify:rel-502-publication-safety` | T0 path + one-shot | live (REL-502 · history secret scan · value print 0 · current-epoch-once --publication-safety) |
| rel-502-current-epoch-once | `verify:rel-502-current-epoch-once` | T0 path + CI | live (REL-502 · Auth+Wallet current-epoch one-shot pin · QA4 full · QA8 PRE-FLIGHT ONLY · persist QA1-QA6 · QA7/QA9/ISSUED 0) |
