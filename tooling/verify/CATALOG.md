...
| acquisition-gap-wire | Track C C-ACQ-002 — **live** (`@aipo/sdk/auth` session/Kakao start/profile · login/signup/complete-profile/onboarding/ads/l 실배선 · PendingFigma 7 유지 · GuestChrome 최소 래퍼 · 잠금 CTA · 맵/성별/Home geometry 0 · 인증=`C-ACQ-003`) |
