...
if (
  pageIsSkeleton("apps/web/app/wallet/deposit/page.tsx") &&
  pageIsSkeleton("apps/web/app/me/kyc/page.tsx") &&
  pageIsSkeleton("apps/web/app/me/support/page.tsx")
) {
  console.log(
    "[stub-page-actions.cjs] PASS — Consumer UI is greenfield skeleton; no Auth/Wallet form invented",
  );
  process.exit(0);
}
