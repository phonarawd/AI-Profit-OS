 ...
 * PART9 home-read binding 보존 · 프레젠테이션 CSS 동결 아님 · domain FSM separate
 */
const fs = require("fs");
...
// PART9 HARD: home-read binding. Presentation CSS/DOM/shell name is not frozen
// (ui-authority-governance.mdc). HomePageV2 parallel home remains forbidden.
