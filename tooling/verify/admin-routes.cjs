...
const childRequired = [
  ...
  "/admin/ai-logs?tab=pick",
  "/admin/ai-logs?tab=eval",
  "/admin/ledger?tab=shadow-replay",
  "/admin/users/:id",
  "/admin/users/:id?tab=opportunities",
  "/admin/users/:id?tab=membership",
  "/admin/users/:id/finance",
  "/admin/users/:id/adjust",
  "/admin/users/:id?tab=policy",
...
const pageDirs = [
  ...
  "app/admin/users/[id]/adjust/page.tsx",
