/**
 * BACKEND-ONLY PORT of tooling/verify/practice-non-withdrawable.cjs (recovery base SHA 86f15964).
...
console.log(
  "[verify:practice-non-withdrawable] PASS (welcome 1x · 7d expire · 403 PRACTICE_NOT_WITHDRAWABLE · journal types · practice->profit path 0)",
);
