/**
 * BACKEND-ONLY PORT of tooling/verify/asset-image-surface.cjs (recovery base SHA 86f15964).
...
console.log(
  "[verify:asset-image-surface] PASS (hydrate · SKU 1:1 · publish guard · R2 · Nest assets API · schemas · CONST46b)",
);
