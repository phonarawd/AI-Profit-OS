/**
 * BACKEND-ONLY PORT of tooling/verify/trading-card-vertical.cjs (recovery base SHA 86f15964).
...
console.log(
  `[verify:trading-card-vertical] PASS (seed=${inv.counts.total} poke=${inv.counts.pokemon} ygo=${inv.counts.yugioh} 소액=${inv.counts.microSmallPct.toFixed(0)}% · grade · ebay · Nest seed/evaluate API)`,
);
