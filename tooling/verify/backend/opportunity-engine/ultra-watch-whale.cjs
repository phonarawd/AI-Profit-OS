/**
 * BACKEND-ONLY PORT of tooling/verify/ultra-watch-whale.cjs (recovery base SHA 86f15964).
...
console.log(
  `[verify:ultra-watch-whale] PASS (seed=${inv.counts.total} PP+AP+Rolex · whale=${inv.counts.byBand.whale} · coexist micro+small=${coexist.ratiosPct.microSmall.toFixed(1)}% · admin_r2 · ebay|admin · Engine chips · Nest seed/match API)`,
);
