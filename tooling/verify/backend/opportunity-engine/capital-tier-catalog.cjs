/**
 * BACKEND-ONLY PORT of tooling/verify/capital-tier-catalog.cjs (recovery base SHA 86f15964).
...
console.log(
  "[verify:capital-tier-catalog] PASS (enum · seed>=40% · Engine chips · CONST46 · Nest capital_band filter)",
);
