/**
 * BACKEND-ONLY PORT of tooling/verify/luxury-bag-vertical.cjs (recovery base SHA 86f15964).
...
console.log(
  `[verify:luxury-bag-vertical] PASS (seed=${inv.counts.total} brands=${Object.keys(inv.counts.byBrand).join("+")} · admin_r2 · ebay|admin · Engine chips · Nest seed/match API)`,
);
