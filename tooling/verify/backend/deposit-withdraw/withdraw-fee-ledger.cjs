/**
 * BACKEND-ONLY PORT of tooling/verify/withdraw-fee-ledger.cjs (recovery base SHA 86f15964).
...
console.log(
  "[verify:withdraw-fee-ledger] PASS (fee keys · FEE_REVENUE · WITHDRAW_FEE_HINT · deposit-config audit)",
);
