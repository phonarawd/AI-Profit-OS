      ...
      "§41+§43 PG-free unique payableAmount + TTL. NEVER: PG사 SDK.",
      {
        ...
        properties: {
          ...
          payableAmountKrw: {
            ...
            minimum: 1,
            description:
              "Actual payment amount = requestedAmountKrw + uniqueSuffixKrw. UNIQUE among active requests",
          },
          uniqueSuffixKrw: {
            type: "integer",
            minimum: 0,
            description:
              "Bank-transfer identification amount. fee=NO · spread=NO · platform revenue=NO",
          },
          payableSuffixRole: {
            type: "string",
            const: "bank_transfer_identification",
          },
          ...
          ledgerJournalId: uuidLike,
          estimatedUsdt: decimal,
          quote: {
            type: ["object", "null"],
            additionalProperties: false,
            required: ["fxSnapshotId", "usdtKrw", "estimatedUsdt"],
            properties: {
          ...
          final: {
            type: ["object", "null"],
            additionalProperties: false,
            required: ["appliedFxSnapshotId", "appliedUsdtKrw", "creditedUsdt"],
            properties: {
              appliedFxSnapshotId: uuidLike,
              appliedUsdtKrw: decimal,
              creditedUsdt: decimal,
              appliedFormulaId: uuidLike,
              appliedFxCapturedAt: iso8601,
              decidedAt: iso8601,
              ledgerJournalId: uuidLike,
            },
          },
