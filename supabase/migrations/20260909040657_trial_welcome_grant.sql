...
COMMENT ON VIEW public.wallet_buckets IS
  'liability = principal+profit+locked+practice; trial_* separate';
...
COMMENT ON TABLE public.trial_grants IS
  'trial welcome 1x; no journal without FX';
