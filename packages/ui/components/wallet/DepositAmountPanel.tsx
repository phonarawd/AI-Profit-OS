...
export function DepositAmountPanel({
  ...
  return (
    ...
    >
      ...
      {suggest > 0 ? (
        <p
          className="text-sm text-[var(--color-lux-text-muted)]"
      ...
      >
        {suggest > 0 ? (
          <button
            ...
            className="rounded-[var(--radius-md)] border border-[var(--color-lux-accent)] px-3 py-2 text-sm text-[var(--color-lux-text)]"
        ...
        {QUICK_USDT.map((n) => (
          <button
            ...
            className="rounded-[var(--radius-md)] border border-[var(--color-lux-border)] px-3 py-2 text-sm text-[var(--color-lux-text)]"
