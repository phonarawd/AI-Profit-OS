...
export function DemoWalletBanner({
  ...
  return (
    <aside
      ...
      className="mt-4 rounded-pd-md border border-pd-border bg-pd-elevated px-4 py-3"
      role="status"
    >
      <div className="flex items-center gap-2">
        <span
          data-testid="practice-badge"
          className="rounded px-2 py-0.5 text-xs font-semibold text-pd-accent"
        >
          {T.practice.badge}
        </span>
      ...
      {practiceUsdt !== undefined && !zero ? (
        <p
          className="mt-2 text-sm text-pd-text"
