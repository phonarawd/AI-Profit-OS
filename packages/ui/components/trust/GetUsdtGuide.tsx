  ...
  return (
    ...
    >
      <header className="space-y-1">
        ...
        <p className="text-sm text-lux-text-muted">{g.lead}</p>
      </header>
      ...
      <section data-testid="get-usdt-choose" className="space-y-2">
        ...
        <div className="flex flex-wrap gap-3 text-sm">
          <Link
            ...
            className="touch-target rounded-lux-md border border-lux-border px-3 py-2"
          >
          ...
          <Link
            ...
            className="touch-target rounded-lux-md border border-lux-accent bg-lux-elevated px-3 py-2 text-lux-accent"
          >
      ...
      <section data-testid="get-usdt-what" className="space-y-2">
        ...
        <p className="text-sm text-lux-text-muted">{g.whatIsUsdtBody}</p>
        <WhyUsdtCard />
        <Link
          href="/me/guide/usdt"
      ...
      <section data-testid="get-usdt-prepare" className="space-y-2">
        ...
        <p className="text-sm text-lux-text-muted">{g.prepareBody}</p>
        <ol className="list-decimal space-y-1 pl-5 text-sm text-lux-text-muted">
          <li>{g.step1}</li>
          <li>{g.step2}</li>
          <li>{g.step3}</li>
        </ol>
      ...
      >
        ...
        <p className="mt-1 text-sm text-lux-text-muted">{g.wrongChainBody}</p>
        <Link
          href="/me/support?category=deposit&kind=wrong_chain"
          data-testid="get-usdt-support-link"
          className="mt-2 inline-block text-sm text-lux-accent underline"
        >
          {g.supportLink}
        </Link>
      </section>
