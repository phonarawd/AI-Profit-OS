/**
 * Admin-compat token module (stack-lock). Not Consumer visual authority.
 * VISUAL_TRUTH = APPROVED_FIGMA_ONLY. Do not recover Home from these hex values.
 *
 ...
 *
 * PHASE 0 VISUAL RESET (2026-08-15):
 * 이 파일의 hex/geometry는 런타임 미러일 뿐, 새 Visual Master 권위가 아니다.
 * 새 Foundation = peotteok-visual-foundation.v0.md · 화면 복제 금지.
 */
