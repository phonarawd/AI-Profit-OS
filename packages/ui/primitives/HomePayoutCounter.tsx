...
export function HomePayoutCounter({
  ...
  return (
    <section
      ...
      className="border-b border-pd-border bg-pd-surface px-4 py-3"
    >
      <p className="text-sm text-pd-text-muted">{T.ticker.todayPayoutLabel}</p>
      <p
        className="mt-1 text-2xl font-semibold tabular-nums text-pd-accent"
