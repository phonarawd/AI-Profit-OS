...
PLAN_LOCKED = TRUE
BLOCKING_ON = []
FIRST_EXECUTION_TODO = REL-701-DB
LAST_COMPLETED_TODO = REL-701-PRE
...
현재 실행 포인터는 헤더의 `FIRST_EXECUTION_TODO = REL-701-DB`. HARD_STOP_AFTER = REL-603. BLOCKING_ON = [FOUNDER_PRODUCTION_AUTHORIZATION]. LAST_COMPLETED_TODO = REL-701-PRE.
