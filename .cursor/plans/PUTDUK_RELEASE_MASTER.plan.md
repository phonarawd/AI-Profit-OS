...
overview: 단일 실행 SSOT. PRE-LOCK 1 + REL 116 + POST 19 = 136개 canonical task definition을 이 파일에 전부 수록. pointer-only 0. PLAN_LOCKED=TRUE. REL-400 COMPLETED. REL-213 COMPLETED. REL-214 COMPLETED. REL-401 COMPLETED. REL-402 COMPLETED. REL-403 COMPLETED. REL-404 COMPLETED. REL-405 COMPLETED. REL-406 COMPLETED. REL-407 COMPLETED. REL-408 COMPLETED. REL-222 COMPLETED. REL-223 COMPLETED. REL-224 COMPLETED. REL-409 COMPLETED. REL-500 COMPLETED. REL-501 COMPLETED. REL-502 COMPLETED. REL-503 COMPLETED. FIRST_EXECUTION_TODO=REL-504. HARD_STOP_AFTER=REL-503. BATCH_REL_200_206=ADMIN_ENTRY.
todos:
  - id: pre-lock-001
...
PLAN_LOCKED = TRUE
BLOCKING_ON = []
FIRST_EXECUTION_TODO = REL-504
LAST_COMPLETED_TODO = REL-503
BATCH_REL_200_206 = ADMIN_ENTRY
HARD_STOP_AFTER = REL-503
PRE_LOCK_COUNT = 1
REL_COUNT = 116
POST_COUNT = 19
...
현재 실행 포인터는 헤더의 `FIRST_EXECUTION_TODO = REL-504`. HARD_STOP_AFTER = REL-503.
