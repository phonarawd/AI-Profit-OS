...
PLAN_LOCKED = TRUE
BLOCKING_ON = []
FIRST_EXECUTION_TODO = REL-508
LAST_COMPLETED_TODO = REL-505
BATCH_REL_200_206 = ADMIN_ENTRY
HARD_STOP_AFTER = REL-505
PRE_LOCK_COUNT = 1
REL_COUNT = 117
POST_COUNT = 19
...
현재 실행 포인터는 헤더의 `FIRST_EXECUTION_TODO = REL-508`. HARD_STOP_AFTER = REL-505.
