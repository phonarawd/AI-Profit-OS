...
overview: "v7.22.24 Money·§43.6a Admin출금PIN·초대∞·Pool·suggestDeposit·PG사0. Index=00."
todos:
  ...
  - id: compliance-wallet
    content: "[composer-2.5|200K] wallet-service §41/§43 TRC20 + 출금모드 + KRW Admin승인/거절 Day-1 + §37 · PG사0 · CSV비필수"
    status: pending
  - id: pg-gateway-ban
  ...
  - id: principal-profit-withdraw
    content: "[composer-2.5|200K] §49 버킷UI·기본=수익만·원금확인시트·3CTA · verify:bucket-invariant/withdraw-mode-default"
    status: pending
...
isProject: false
---
# AI Profit OS — Money & Chain (v7.22.24)
